...
*window_opacity* = _integer_::
Opacity percentage for the first all-window opacity mode. Alt+mouse wheel
adjusts the currently selected mode. +
Default value: *30*

*window_opacity_alt* = _integer_::
Opacity percentage for the second all-window opacity mode. +
Default value: *100*

*text_opacity* = _integer_::
Opacity percentage for terminal content in all windows. Ctrl+Alt+mouse wheel
adjusts this value without changing the configured terminal background. +
Default value: *100*

*window_vertical_mask* = _integer_::
Initial vertical transparency boundary as a percentage of window height.
Content above the boundary is fully transparent; Shift+Alt+mouse wheel moves
the boundary for the current window. +
Default value: *0*

*window_vertical_mask_step* = _integer_::
Percentage-point step used when Shift+Alt+mouse wheel moves the current
window's vertical transparency boundary. +
Default value: *1*
